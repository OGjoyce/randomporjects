...
encode:
   ...
   BL get_next_word   //como comparar con todos los casos?
   LDR x0,=ADD_
   LDR x1,=WORD
   BL strcmp
   CMP x0,#0
   ...
   CMP x0,#0
   B.EQ subs_case
   //como hacer el de los immediate??
   LDR x0,=AND_
   BL strcmp
   CMP x0,#0
   B.EQ and_case
...
add_case:
   ...
   STR x23,[SP,#0]
   MOV w23,#0x8B0
   LSL w23, w23, #20 //porque en un add los valores predeterminados van del 21 al 31
...
cbnz_case:
   ...
   BL get_next_word
   BL get_register
   LSL x0, x0, #5 //registro rn
   ORR x23, x23, x0
   BL get_next_word
   BL get_register
   LSL x0, x0, #16 //resgistro rm
   ORR x23, x23, x0
   STR w23,[x20,#0]
   ADD x20, x20, #4
   LDR x23,[SP,#0]
...
finish_encode:
   ...
   ADD SP, SP, #32
   RET
   //para el adds sub y subs solo definir una constante tal como esta add 
   //y cambiar el numero fijo que forman los cofigos del 31 al 21 . en hex 
   //que en este caso seria 0x8B0.Seguir el mismo formato para las demas.  
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////FINISH ENCODE///////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
